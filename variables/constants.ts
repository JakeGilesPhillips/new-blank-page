...
export const chatMessages: string[] = [
  ...
  "You can navigate by clicking on different icons.",
  "Feel free to get in touch by sending us a message in the contact application.",
  "I will now endlessly compliment you until you close me",
